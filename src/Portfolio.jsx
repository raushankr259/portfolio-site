...
const PROFILE = {
  ...
  summary:
    "I deliver real product impact by transforming raw product data into actionable insights. My expertise spans SQL, Python, Power BI, and Mixpanel — helping teams improve retention, optimize funnels, and make smarter product decisions.",
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {caseStudies.map((p, i) => (
              <div
                key={i}
                className="p-5 rounded-xl bg-slate-800 hover:scale-[1.02] transition shadow-lg"
              >
